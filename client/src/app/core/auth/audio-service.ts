...
export class AudioService {
  ...
  public currentTrack: BehaviorSubject<string> = new BehaviorSubject('');
  ...
  public getCurrentTrack(): Observable<string> {
    return this.currentTrack.asObservable();
  }

  loadAudio(id: string, snippet: boolean) {

    let route: string = this.env + '/song';
    if (snippet) {
      route += '/snippet';
    }
